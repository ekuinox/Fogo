...
auto Car::createPipelineStateObject() -> void {
	...
	*/
	constexpr D3D12_INPUT_ELEMENT_DESC inputElementDesc[6] {
		// セマンティック名　index　　 format　　　　　　　　　　　   slot　　byteoffset　　　　　     
		{ "POSITION",        0,      DXGI_FORMAT_R32G32B32_FLOAT,      0,      0,										D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },	// 頂点座標
		{ "COLOR",           0,      DXGI_FORMAT_R32G32B32A32_FLOAT,   0,      4 * 3,									D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },	// 頂点カラー
		{ "NORMAL",          0,      DXGI_FORMAT_R32G32B32_FLOAT,      0,      4 * 4 + 4 * 3 ,							D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },	// 法線ベクトル
		{ "TEXCOORD",        0,      DXGI_FORMAT_R32G32_FLOAT,         0,      4 * 3 + 4 * 4 + 4 * 3,					D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },	// テクスチャ座標
